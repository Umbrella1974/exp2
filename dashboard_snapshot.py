"""Display-only dashboard snapshots for live visual preview.

This module translates controller outputs into JSON-safe labels. It does not
change controller, haptic, or trial semantics.
"""
...
class DashboardSnapshot:
    """One JSON-safe display snapshot consumed by visual/text dashboards."""
