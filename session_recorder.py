...
class SessionRecorder:
    ...
    def record_processed_frame(
        ...
        row = {
            ...
            "boundary_lock_active": _attr(feedback, "boundary_lock_active"),
            "boundary_lock_surface": _name(_attr(feedback, "boundary_lock_surface")),
            "boundary_lock_escape_progress": _attr(feedback, "boundary_lock_escape_progress"),
            "boundary_lock_unlock_delta_m": _attr(feedback, "boundary_lock_unlock_delta_m"),
            "boundary_lock_event": _attr(feedback, "boundary_lock_event"),
