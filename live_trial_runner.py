        ...
        payload.update(
            {
                ...
                "thumb_node": self.config.thumb_node,
                "index_node": self.config.index_node,
                "tracker_index": self.config.tracker_index,
                "skeleton_index": self.config.skeleton_index,
                "pinch_node_config": {
                    "thumb_node": self.config.thumb_node,
                    "secondary_node": self.config.index_node,
                ...
                "pinch_threshold": {
                    "grab": self.engine_config.pinch_grab_threshold,
                    "release": self.engine_config.pinch_release_threshold,
                },
                "pinch_on_threshold_m": self.engine_config.pinch_grab_threshold,
                "pinch_off_threshold_m": self.engine_config.pinch_release_threshold,
